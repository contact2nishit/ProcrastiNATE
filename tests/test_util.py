...
# Tests for partition_by_meeting_id function
class TestPartitionByMeetingId:
    ...
    def test_multiple_items_different_fields(self):
        ...
        result = partition_by_meeting_id(data, 'id')
        assert len(result) == 3
        # Check that each partition has one item
    ...
    def test_mixed_grouping(self):
        ...
        # Find groups by checking first item's meeting_id
        group_sizes = {}
        for group in result:
    ...
    def test_string_field_values(self):
        ...
        # Check that work and personal categories each have 2 items
    ...
    def test_none_field_values(self):
        ...
        assert len(result) == 3  # None, 'active', 'inactive'
        
        # Find None group and check its size
        none_group_size = 0
        for group in result:
    ...
    def test_boolean_field_values(self):
        ...
        assert len(result) == 2  # True, False
        
        # Check both groups have 2 items each
        for group in result:
            assert len(group) == 2
...
class TestGetLatestTime:
    ...
    def test_only_assignments(self):
        ...
        # Should return the latest due date (August 1st)
    ...
    def test_only_chores(self):
        ...
        # Should return the latest window end time
    ...
    def test_only_meetings(self):
        ...
        # Should return the latest meeting end time
    ...
    def test_mixed_events(self):
        ...
        # Should return the chore window end time (August 1st 18:00)
    ...
    def test_naive_datetime_handling(self):
        ...
        # Should return the assignment due date (converted to UTC)
    ...
    def test_single_event_each_type(self):
        ...
        # Meeting end time is latest (July 30th 10:00)
